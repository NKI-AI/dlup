...
```
Teuwen, J., Romor, L., Pai, A., Schirris, Y., Marcus E. (2023). DLUP: Deep Learning Utilities for Pathology (Version 0.3.32) [Computer software]. https://github.com/NKI-AI/dlup
```
