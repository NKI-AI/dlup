...
class BasePreprocessor(abc.ABC):
    ...
    def _save_tile_metadata(
        ...
        tile_metadata = {**tile_tuple.region}
        filename = f"tile_{'_'.join(map(str, tile_tuple.region.idx.tolist()))}" + ".json"
        write_json(save_dir / self.json_dir / filename, tile_metadata)
